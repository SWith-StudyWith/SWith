        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="overflow-auto card fw-light" style="height: 10rem">
              제 1 장 총 칙
              제1조 목적
              이 약관은 “주식회사 구루미(이하 “회사”)”이 제공하는 “구루미”와 관련하여 회사와 이용자 간의 권리와 의무 및 필요한 사항을 정하는데 그 목적이 있습니다.
              제 2 조 (용어의 정의)
              1. 이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
              1) "구루미캠스터디(이하 "서비스")"란 PC와 모바일에서 카메라를 통해 서로의 공부하는 영상을 공유하고 강의를 준비하는 선생님과 수업을 듣는 학생이 학습할 수 있도록 제공하는 미디어 플랫폼입니다.
              ...
              5) "구룸"이란 이용자가 서비스내 아이템을 구매할 수 있는 서비스내 재화를 의미합니다.
              6) "구룸샵"이란 구룸을 통해 이용자가 아이템을 구매할 수 있는 서비스의 기능을 의미합니다.
              7) "충전"이란 이용자가 구룸샵의 아이템을 구매하기 위해 회사에서 제공하는 결제수단으로 현금을 구룸으로 전환하는 행위를 말합니다.
              8) "프리미엄 이용권"이란 이용자가 프리미엄 스터디룸 개설 및 이용을 위한 온라인 상품권을 의미합니다.
              9) "오프라인 실물상품" 이란 이용자가 구룸샵 내에서 구매하여 지정한 배송지로 배송 받을 수 있는 실물 상품을 의미합니다.
              10) "환불"이란 이용자가 충전한 구룸이나 구매한 프리미엄 이용권, 오프라인 실물상품을 현금으로 되돌려 받는 것을 말합니다.
              11) "탈퇴"란 이용자가 서비스 이용 계약을 종료하는 의사표시를 말합니다.
