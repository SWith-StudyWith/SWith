...
<div class="not-found">
  <div class="container row">
    <div class="col-6">
      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="470" height="290" viewBox="0 0 470 290">
          ...
          <g fill="none" fill-rule="evenodd">
              <path fill="#F1F6FF" d="M0 0H1366V800H0z" transform="translate(-448 -157)"/>
              <g transform="translate(-448 -157) translate(448 157)">
                  <mask id="prefix__b" fill="#fff">
                      <use xlink:href="#prefix__a"/>
                  </mask>
                  <use fill="#e3e9f5" xlink:href="#prefix__a"/>
                  <path fill="#ccd1db" fill-rule="nonzero" d="M-14.199 211.2H481.36V301.2H-14.199z" mask="url(#prefix__b)"/>
                  <g class="paes">
                  <g class="pao-baixo">
    ...
    <div class="col-6 text">
      <span style="font-size: 90px; font-weight:800;">404</span> &nbsp
      <span class="error">Page Not Found</span>
      <p class="msg">We are sorry but the page you are looking for does not exist.</p>
      <router-link class = "toMain" :to="{ name: 'Main' }">
        <button type="button" class="btn">Go Back SWith !</button>
      </router-link>
    </div>
  </div>
</div>
